...
1. User's bid on an item, each new bid must be at a higher price than before
...
Description:
	...
	-3 tables (.txt) are used for storage. Each entry is a string tuble of its fields. Id's are used to easily retreive related data in different tables.
-------------------------------------------------------------------------------------------------------
